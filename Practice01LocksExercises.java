...
/*
Ответы на вопросы:
1) нет, взаимную блокировку организовать нельзя так как к моменту освобождения первого ресурса все остальные будут свободны, а благодаря установленному порядку захвата ресурсов неудасться захватить ресурс 2 раньше ресурса 1
2) нет, дедлока тоже не будет так как захватить уже захваченный ресурс нельзя, а захват ресурса регулируется установленным правилом
*/
